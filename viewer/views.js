...
export const VIEWS = {
  ...
  reference: { azimuth: 148, elevation: 12, distance: 1.32, fov: 32, target: [0, 0.30, 0] },

  bow: { azimuth: 178, elevation: 8, distance: 1.15, fov: 34, target: [0, 0.22, 0] },
  beam: { azimuth: 90, elevation: 6, distance: 1.20, fov: 32, target: [0, 0.28, 0] },
  quarter: { azimuth: 42, elevation: 14, distance: 1.15, fov: 34, target: [0, 0.26, 0] },
  stern: { azimuth: 2, elevation: 9, distance: 1.02, fov: 34, target: [0, 0.20, 0] },
  masthead: { azimuth: 120, elevation: 46, distance: 0.78, fov: 40, target: [0, 0.44, 0] },
  deck: { azimuth: 6, elevation: 3, distance: 0.30, fov: 55, target: [0, 0.16, -0.06] },

  // Close studies, used when iterating on a specific area.
  head: { azimuth: 158, elevation: 4, distance: 0.42, fov: 36, target: [0, 0.13, -0.34] },
  gallery: { azimuth: 34, elevation: 5, distance: 0.36, fov: 36, target: [0, 0.14, 0.36] },
  channels: { azimuth: 84, elevation: 4, distance: 0.40, fov: 36, target: [0, 0.15, 0] },
  underwater: { azimuth: 118, elevation: -16, distance: 1.05, fov: 34, target: [0, -0.02, 0] },
};
